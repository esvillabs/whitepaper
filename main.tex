...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{Esvil Protocol --- Whitepaper v2.0}}
...
\begin{enumerate}[nosep]
    ...
    \item A \textbf{pluggable compliance engine} that enforces jurisdiction-specific rules through composable compliance modules, enabling the same protocol to operate across Nigeria, Switzerland, Estonia, Singapore, and beyond.
\end{enumerate}
