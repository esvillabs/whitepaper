...
{\large David Nzagha \quad Luo Yang \quad Wu Qin \quad Chibuzor Udokwu}\\[0.3cm]
...
\includegraphics[width=3.5cm]{figures/esvil-logo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/fig-konash-title-token.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/fig-joshi-re-problems.png}
